...
- [Generative UI Specs Overview](/ms-agent-python/concepts/generative-ui-overview) - Compare all supported specifications
- [Generative UI Guide](/ms-agent-python/generative-ui/tool-based) - Build with Generative UI in CopilotKit
- [A2UI Site](https://a2ui.org/) - Visit the A2UI site
- [AG-UI Protocol](/ms-agent-python/agentic-protocols/ag-ui) - Learn about the protocol that supports A2UI
- [Open-JSON-UI](/ms-agent-python/generative-ui/open-json-ui) - OpenAI's alternative approach
- [MCP Apps](/ms-agent-python/generative-ui/mcp-apps) - Iframe-based Generative UI extending MCP
